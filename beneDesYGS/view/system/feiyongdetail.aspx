<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feiyongdetail.aspx.cs" Inherits="beneDesYGS.view.system.feiyongdetail" %>
...
<%--		<link href="../../static/css/commonSpread.css" rel="stylesheet" type="text/css" />
	...
	<body style=" overflow: hidden; WIDTH: 974px; HEIGHT: 584px; text-align:center;background-image:url(../static/image/bg.jpg)">
                    ...
                    <td width="680" colspan="2" style="height: 45px">
                        <table id="Table11" cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr>
											...
											<td class="css style7" style="width: 642px; text-align:left">
                                                &nbsp;<asp:Label ID="labShow" runat="server" ForeColor="Red" Width="320px" Font-Size="X-Small"></asp:Label></td>
                ...
                <tr>
								<td  style="width: 611px; vertical-align:bottom; height: 15px;" colspan="2">
									<table id="Table12" cellspacing="0" cellpadding="0" width="740" style="text-align:right"  border="0">
										<tr class="css">
											<td  style="height: 39px; width:50%; vertical-align:bottom" align="left">&nbsp;</td>
