<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="csh.aspx.cs" Inherits="beneDesYGS.view.month.csh" %>
...
<body style="overflow: hidden;  WIDTH: 950px; HEIGHT: 665px; text-align:center; background-image:url(/static/image/bg.jpg);">
            ...
            <div style="text-align: center">
                <div style="text-align: center">
                    <table style="width: 690px">
                        ...
                        <tr>
                            <td colspan="3" style="height: 4px" align="left">
                                &nbsp;</td>
                        </tr>
                    </table>
                </div>
        ...
        <table style="width: 630px" >
            <tr>
                <td style="width: 630px; height: 9px; text-align: left">
                </td>
            </tr>
            <tr class="css">
                <td style="width: 630px; height: 28px; text-align: left;">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                       &nbsp;
                                       &nbsp;
                                       </td>
                ...
                <td style="width: 630px; height: 426px; text-align: left; vertical-align : top">
                    ...
                    <asp:Button ID="Btnqd" runat="server" Text="初始化" Width="60px" OnClick="Btnqd_Click" Font-Size="10pt" />--%>
                                ...
                                <tr>
                                    ...
                                    <asp:Label ID="Label7" runat="server" Font-Size="Smaller" Text="Label" ForeColor="Red"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox3" runat="server" Text="月度资源税" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                ...
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox9" runat="server" Text="月度人民币汇率" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                ...
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox8" runat="server" Text="月度吨桶比信息" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                ...
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox10" runat="server" Text="月度期间勘探费信息" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                    <asp:Label ID="Label10" runat="server" Font-Size="Smaller" Text="Label" ForeColor="Red"></asp:Label></td>
                                 </tr>
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox6" runat="server" BorderColor="Red" Text="月度销售参数" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                ...
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox2" runat="server" Text="特别收益金" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                ...
                                <tr>
                                    <td style="width: 220px; height: 26px;vertical-align :top">
                                        <span style="font-size: 10pt">
                                            <asp:CheckBox ID="CheckBox1" runat="server" Text="参数定义" /></span></td>
                                    <td style="width: 450px; height: 26px;">
                                    <asp:Label ID="Label1" runat="server" Font-Size="Smaller" Text="Label" ForeColor="Red"></asp:Label></td>
                                </tr>
                                <%--<tr>
