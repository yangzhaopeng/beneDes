<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrameYQ.aspx.cs" Inherits="beneDesYGS.view.spreadframeYQ.commonSpreadFrameYQ" %>
...
<%--    <script src="../../static/js/common/commonSpreadFrameYQ.js" type="text/javascript"></script>--%>
    <script src="../../static/js/spreadframeYQ/commonSpreadFrameYQ.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>
