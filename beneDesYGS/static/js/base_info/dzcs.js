Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加地质措施');
            formPanel.getForm().reset();
            formPanel.getForm().findField('DZCSDM').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该地质措施？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '../../api/base_info/dzcs.aspx',
    ...
    */
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            { text: '代码', dataIndex: 'DZCSDM' },
            { text: '名称', dataIndex: 'DZCSMC', width: 400, fixed: true },
