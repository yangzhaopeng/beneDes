Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加销售油品');
            formPanel.getForm().reset();
            formPanel.getForm().findField('XSYPDM').setReadOnly(false);
            formPanel.getForm().findField('XSYPMC').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该销售油品？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '../../api/base_info/xsyp.aspx',

                        {
                            _type: 'delete',
                            BZ: gridSel.data['BZ'],
                            XSYPDM: gridSel.data['XSYPDM'],
                            XSYPMC: gridSel.data['XSYPMC']
                        },
    ...
    */
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '名称', dataIndex: 'XSYPMC', width: 400, fixed: true },
