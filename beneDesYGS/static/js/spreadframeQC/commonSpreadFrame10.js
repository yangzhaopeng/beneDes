Ext.onReady(function() {
    ...
    var events = {
        // 检索
        search: function() {
            var yt = Ext.getCmp('zyq').getValue();
            ...
            document.getElementById('center').setAttribute('src', iframeUrl + '?tgcb='+tgcb+'&targetType=' + targetType + '&startMonth=' + startMonth + '&endMonth=' + endMonth + '&CYC=' + cyc);
            // loading的实现
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            '-',
            { xtype: 'radio', boxLabel: '区块', name: 'targetType', checked: true, margin: '0 20 0 30', id: 'qk' },
            ...
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', value: 'quan', labelWidth: 40, labelAlign: 'right', name: 'CYC', id: 'CYC', store: departmentStore, displayField: 'DEP_NAME', valueField: 'DEP_ID', queryMode: 'local', allowBlank: false },
            '-',
            { xtype: 'label', text: '特高成本：', margin: '0 0 0 15' },
            { xtype: 'textfield', name: 'tgcb', id: 'tgcb', value: 400, readOnly: false, width: 100 },
             '-',
