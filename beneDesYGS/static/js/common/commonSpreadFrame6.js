Ext.onReady(function() {
    ...
    var events = {
        ...
        search: function() {
            ...
            var yclx = Ext.getCmp('YCLX').getValue();

            document.getElementById('center').setAttribute('src', iframeUrl + '?startMonth=' + startMonth + '&endMonth=' + endMonth + '&CYC=' + cyc + '&YCLX=' + yclx + '&CYC_NAME=' + cycname);
            // loading的实现
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        //{ xtype: 'textfield', name: 'jgsz', id: 'jgsz', value: jgsz, emptyText: '16.5,20,25,30,35,40,45,50,70,90,120', width: 300 },
            {xtype: 'combo', fieldLabel: '油藏类型', name: 'YCLX', id: 'YCLX', value: '低渗透砂岩油藏', labelWidth: 60, labelAlign: 'right', store: yclxStore, displayField: 'YCLX', valueField: 'YCLX', queryMode: 'local', allowBlank: true },
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', name: 'CYC', id: 'CYC', labelWidth: 40, labelAlign: 'right', store: departmentStore, displayField: 'DEP_NAME', valueField: 'CYC_ID', queryMode: 'local', allowBlank: false },
            '-',
