Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        //{ xtype: 'radio', boxLabel: '作业区', name: 'targetType', margin: '0 10 0 0', id: 'zyq' },
            ...
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', name: 'CYC', value: 'quan', id: 'CYC', labelWidth: 40, labelAlign: 'right', store: departmentStore, displayField: 'DEP_NAME', valueField: 'DEP_ID', queryMode: 'local', allowBlank: false },
            '-',
