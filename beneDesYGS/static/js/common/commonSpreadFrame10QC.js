Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            ...
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', labelWidth: 40, labelAlign: 'right', name: 'CYC', id: 'CYC', store: departmentStore, displayField: 'DEP_NAME', valueField: 'CYC_ID', queryMode: 'local', allowBlank: false },  
            '-',
