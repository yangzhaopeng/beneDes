Ext.onReady(function() {
    ...
    var events = {
        ...
        document.getElementById('center').contentDocument.getElementById("ImgButZj").click();
        },

        // 修改
        modify: function() {
            // 触发iframe中隐藏的button按钮的click事件
        document.getElementById('center').contentDocument.getElementById("ImgButXg").click();
        },

        // 删除
        deleteB: function() {
            // 触发iframe中隐藏的button按钮的click事件
        document.getElementById('center').contentDocument.getElementById("ImgButSc").click();
        },
...
//            { xtype: 'button', text: '检索', iconCls: 'icon-search', handler: events.search, hidden: true, hiddenLabel: true },
             '-',
            { xtype: 'button', text: '增加', iconCls: 'icon-add', handler: events.add },
            '-',
            { xtype: 'button', text: '修改', iconCls: 'icon-edit', handler: events.modify },
             '-',
            { xtype: 'button', text: '删除', iconCls: 'icon-delete', handler: events.deleteB },
            '-',
