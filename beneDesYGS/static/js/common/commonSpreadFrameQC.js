Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            ...
            '-',
            { xtype: 'combo', fieldLabel: '采气厂', labelWidth: 40, name: 'CYC', id: 'CYC', store: departmentStore, displayField: 'DEP_NAME', valueField: 'CYC_ID', queryMode: 'local', labelAlign: 'right', allowBlank: false },
            '-',
