Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            '-',
            { xtype: 'radio', boxLabel: '井', name: 'targetType', checked: true, margin: '0 20 0 30', id: 'yt' },
            { xtype: 'radio', boxLabel: '评价单元', name: 'targetType', margin: '0 10 0 0', id: 'pjdy' },
            '-',
            { xtype: 'label', text: '评价时段:' },
            { xtype: 'textfield', name: 'startDate', value: startMonth, readOnlyCls: 'readOnly', align: 'center', readOnly: true, width: 60 },
            '至',
            { xtype: 'textfield', name: 'endDate', value: endMonth, readOnlyCls: 'readOnly', readOnly: true, width: 60 },
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', labelWidth: 40, name: 'CYC', id: 'CYC', store: departmentStore, displayField: 'DEP_NAME', valueField: 'CYC_ID', queryMode: 'local', labelAlign: 'right', allowBlank: false },
            '-',
