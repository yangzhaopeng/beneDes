Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            '-',
            { xtype: 'radio', boxLabel: '井', name: 'targetType', margin: '0 10 0 0', checked: true, id: 'yt' },
            ...
            '-',
            { xtype: 'combo', fieldLabel: '采油厂', value: 'quan', name: 'CYC', id: 'CYC', labelWidth: 40, labelAlign: 'right', store: departmentStore, displayField: 'DEP_NAME', valueField: 'DEP_ID', queryMode: 'local', allowBlank: false },
            '-',
