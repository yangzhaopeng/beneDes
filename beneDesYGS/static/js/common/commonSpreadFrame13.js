Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        //{ xtype: 'radio', boxLabel: '作业区', name: 'targetType', margin: '0 10 0 0', id: 'zyq' },
            ...
            '-',
            { xtype: 'combo', name: 'CYC', id: 'CYC', value: 'quan', store: departmentStore, labelWidth: 40, labelAlign: 'right', displayField: 'DEP_NAME', valueField: 'DEP_ID', triggerAction: 'all'
                    , listeners: {
                        select: {
            ...
            '-',
            { xtype: 'combo', name: 'zdw', id: 'zdw', hiddenName: 'zdw', width: 80, displayField: 'DEP_NAME', valueField: 'DEP_ID', queryMode: 'local', triggerAction: 'all' },
            '-',
