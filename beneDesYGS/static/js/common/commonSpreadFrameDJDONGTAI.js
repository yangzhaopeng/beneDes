Ext.onReady(function() {
    ...
    var events = {
        ...
        search: function() {
            ...
            //            document.getElementById('center').setAttribute('src', iframeUrl + '?CYC=' + cyc + '&xzType=' + xzType + '&xzType2=' + xzType2 + '&xzType3=' + xzType3 + '&xzType4=' + xzType4 + '&xzType5=' + xzType5 + '&SJCX=' + SJCX + '&SJCX2=' + SJCX2 + '&SJCX3=' + SJCX3 + '&SJCX4=' + SJCX4 + '&SJCX5=' + SJCX5 + '&ROAND=' + ROAND + '&ROAND2=' + ROAND2 + '&ROAND3=' + ROAND3 + '&ROAND4=' + ROAND4);
            //            // loading的实现
            //            Loading.onIfrmaLoad('center');
        },
    ...
    var xzTypeStore = new Ext.data.ArrayStore({
        fields: ['XZID', 'XZNAME'],
        data: [
     ['bny', '开始时间'], ['eny', '结束时间'], ['qk', '区块'], ['jh', '井号'], ['pjdy', '评价单元'], ['yqlxmc', '油气类型'], ['xsypmc', '销售油品'], ['ssyt', '所属油田'], ['yclx', '油藏类型'], ['jbmc', '效益类别']
    ]
    });
