Ext.onReady(function() {
    ...
    var events = {
        // 检索
        search: function() {
        var targetType = Ext.getCmp('pjdy').getValue() ? 'pjdy' : 'qk';
            ...
            //document.getElementById('center').contentDocument.getElementById("JS").click();
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            '-',
            { xtype: 'radio', boxLabel: '评价单元', name: 'targetType', checked: true, margin: '0 20 0 30', id: 'pjdy' },
