Ext.onReady(function() {
    ...
    var events = {
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该吨桶比？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '/api/month/dtb.aspx',
    ...
    */
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        fields: ['NY', 'XSYP', 'XSYPDM', 'XSYPMC', 'DTB'],
        autoLoad: true
    });
...
//            { text: '吨桶比（吨/桶）', dataIndex: 'DTB' },
//            { text: '代码', dataIndex: 'XSYPDM' }
        ],

        tbar: [
            '-',
            { xtype: 'button', text: '获取基础数据', iconCls: 'icon-add', handler: events.addOrEdit },
//            '-',
