Ext.onReady(function() {
    ...
    var events = {
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该参数信息？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
...
//        width: 380,
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        proxy: {
            type: 'ajax',
            url: '../../api/month/xsypRelateY.aspx',
        ...
        fields: ['NY', 'XSYPDM', 'JG', 'SJ','YQSPL','ZYS','DTB', 'XSYPMC'],
        autoLoad: true
    });
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '销售油品', dataIndex: 'XSYPMC' ,width:150},
            { text: '油气商品率（%）', dataIndex: 'YQSPL',width:150 },
            { text: '吨桶比（桶/吨）', dataIndex: 'DTB' ,width:150},
            { text: '资源税（%）', dataIndex: 'ZYS' ,width:120},
            { text: '税金（元/吨）', dataIndex: 'SJ' ,width:120},
            { text: '价格（元/吨）', dataIndex: 'JG' ,width:120}
        ],
