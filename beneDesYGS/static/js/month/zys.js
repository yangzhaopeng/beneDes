Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加资源税');
            formPanel.getForm().reset();
            formPanel.getForm().findField('NY').setReadOnly(false);
            formPanel.getForm().findField('YQLX').setReadOnly(false);
            formPanel.getForm().findField('ZYS').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该资源税？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '/api/month/zys.aspx',
    ...
    */
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        fields: ['NY','YQLX','YQLXDM','YQLXMC','ZYS'],
        autoLoad: true
    });
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '油气类型', dataIndex: 'YQLXMC', width: 400, fixed: true },
            { text: '资源税（元/吨 或 元/千方)', dataIndex: 'ZYS', width: 155 },
            { text: '代码', dataIndex: 'YQLXDM'}
        ],
