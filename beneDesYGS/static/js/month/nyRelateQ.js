...
Ext.onReady(function() {
    ...
    var events = {
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该条信息？', function(result) {
                if (result == 'yes') {
                    NY: month
                    dataJs.get(
                        '../../api/month/nyRelateQ.aspx',
        ...
        distribute: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要分发该参数信息？', function(result) {
                if (result == 'yes') {
                    NY: month
                    dataJs.get(
                        '../../api/month/nyRelateQ.aspx',
    ...
    */
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '汇率（元/美元）', dataIndex: 'HL' ,width:130},
            { text: '体积换算系数（立方米/吨）', dataIndex: 'DLY',width:220 },
            { text: '期间费用（元/千方）', dataIndex: 'QJFY',width:160 },
            { text: '勘探费用（元/千方）', dataIndex: 'KTFY',width:160 }
        ],
        ...
        tbar: [
            ...
            '-',
            { xtype: 'button', text: '分发', iconCls: 'icon-交流空间2', handler: events.distribute },
            '-'
