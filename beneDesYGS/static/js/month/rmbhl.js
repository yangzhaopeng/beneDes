Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加人民币汇率');
            formPanel.getForm().reset();
            formPanel.getForm().findField('NY').setReadOnly(false);
            formPanel.getForm().findField('HL').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该人民币汇率？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '/api/month/rmbhl.aspx',
    ...
    */
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '人民币汇率', dataIndex: 'HL', width: 400, fixed: true },
            { text: '', dataIndex: 'BZ' },
