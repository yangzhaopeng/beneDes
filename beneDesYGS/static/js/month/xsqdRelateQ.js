Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加销售渠道参数信息');
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该销售渠道参数信息？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
...
//                            XSYPDM: gridSel.data['XSYPDM']
        ...
        editClick: function() {
            ...
            isAdd = false;
            windowDialog.setTitle('编辑销售渠道参数信息');
...
//        width: 380,
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '销售渠道', dataIndex: 'XSYPMC',width:150 },
            { text: '油气商品率（%）', dataIndex: 'YQSPL',width:150 },
             { text: '吨桶比（桶/吨）', dataIndex: 'DTB',width:150 },
            { text: '资源税（%）', dataIndex: 'ZYS',width:120 },
            { text: '税金（元/千方）', dataIndex: 'SJ',width:130 },
            { text: '价格（元/千方）', dataIndex: 'JG' ,width:130}
        ],
