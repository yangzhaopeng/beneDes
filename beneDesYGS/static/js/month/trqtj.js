Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加天然气体积换算系数');
            formPanel.getForm().reset();
            formPanel.getForm().findField('NY').setReadOnly(false);
            formPanel.getForm().findField('DLY').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该天然气体积换算系数？', function(result) {
                if (result == 'yes') {
                    dataJs.get(
                        '/api/month/trqtj.aspx',
        ...
        editClick: function() {
            ...
            isAdd = false;
            windowDialog.setTitle('编辑天然气体积换算系数');
    ...
    */
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { text: '天然气量(立方米天然气)', dataIndex: 'DLY', width: 400, fixed: true },
            { text: '', dataIndex: 'BZ' },
