...
//                                                                <asp:ListItem Value="DJ">单井</asp:ListItem>
    ...
    var weihuStore = new Ext.data.JsonStore({
    ...
    var mobanStore = new Ext.data.JsonStore({
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        fields: ['TEMPLET_CODE', 'TEMPLET_NAME', 'TEMPLET_TYPE', 'U_TYPE', 'USE_TYPE', 'TEMPLET_LEVEL', 'T_LEVEL', 'TEMPLET_TAG'],
        autoLoad: true
    });
