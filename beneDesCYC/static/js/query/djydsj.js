Ext.onReady(function() {
    ...
    var events = {
       ...
       // var cyc = Ext.getCmp('CYC').getValue();
        ...
        document.getElementById('center').setAttribute('src', iframeUrl + '?xzType=' + xzType + '&xzType2=' + xzType2 + '&xzType3=' + xzType3 + '&xzType4=' + xzType4 + '&xzType5=' + xzType5 + '&SJCX=' + SJCX + '&SJCX2=' + SJCX2 + '&SJCX3=' + SJCX3 + '&SJCX4=' + SJCX4 + '&SJCX5=' + SJCX5 + '&ROAND=' + ROAND + '&ROAND2=' + ROAND2 + '&ROAND3=' + ROAND3 + '&ROAND4=' + ROAND4);
            // loading的实现
...
//            formPanel.getForm().setValues(gridSel.data);
    ...
    var xzTypeStore = new Ext.data.ArrayStore({
        fields: ['XZID', 'XZNAME'],
        data: [
     ['ny', '时间'], ['jh', '井号'], ['qk', '区块'], ['pjdy', '评价单元'], ['yqlxmc', '油气类型'], ['xsypmc', '销售油品'], ['ssyt', '所属油田'], ['yclx', '油藏类型']
    ]
    });
                    ...
                    var Panel6 = Ext.create('Ext.form.Panel', {
                        ...
                        items: [{
                            ...
                            listeners: {
                              ...
                              //      var cyc = Ext.getCmp('CYC').getValue();
                                    var sjcxStore5 = Ext.create('Ext.data.Store', {
                                        proxy: {
                                            type: 'ajax',
                                            url: '../../api/system/djydsjcx.aspx',
                        ...
                        var formPanel = Ext.create('Ext.form.Panel', {
                            ...
                            items: [Panel2,Panel3,Panel4,Panel5,Panel6],
