    ...
    var events = {
        ...
        search: function() {
         ...
         //   var cyc = Ext.getCmp('CYC').getValue();
            ...
            document.getElementById('center').setAttribute('src', iframeUrl + '?startMonth=' + startMonth + '&endMonth=' + endMonth +  '&YCLX=' + yclx);
            // loading的实现
...
//    });
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        //'-',
            ...
            { xtype: 'combo', fieldLabel: '油藏类型', name: 'YCLX', id: 'YCLX', store: yclxStore,labelAlign: 'right', displayField: 'YCLX', valueField: 'YCLX', queryMode: 'local', allowBlank: true },
            '-',
