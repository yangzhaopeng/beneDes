...
//    });
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            ...
            '-',
//            { xtype: 'combo', fieldLabel: '采油厂', labelWidth:40, name: 'CYC', id: 'CYC', store: departmentStore, displayField: 'DEP_NAME', valueField: 'DEP_ID', queryMode: 'local', allowBlank: false },
//            '-',
