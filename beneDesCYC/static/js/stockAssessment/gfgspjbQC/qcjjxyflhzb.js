Ext.onReady(function() {
    ...
    var events = {
        ...
        search: function() {
            ...
            document.getElementById('center').setAttribute('src', iframeUrl + '?startMonth=' + startMonth + '&endMonth=' + endMonth + '&QCLX=' + qclx);
            // loading的实现
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        //{ xtype: 'textfield', name: 'jgsz', id: 'jgsz', value: jgsz, emptyText: '16.5,20,25,30,35,40,45,50,70,90,120', width: 300 },
            {xtype: 'combo', fieldLabel: '气藏类型', name: 'QCLX', id: 'QCLX', labelWidth: 53, store: yclxStore, displayField: 'QCLX', valueField: 'QCLX', queryMode: 'local', allowBlank: true},
            '-',
    ...
    yclxStore.on('load', function() { Ext.getCmp('QCLX').setValue('凝析气藏'); });
