...
//            },
//            '-',
            { xtype: 'combo', name: 'dwType', id: 'dwType', width: 70, store: dwTypeStore, labelWidth:53,displayField: 'DWNAME', valueField: 'DWID', triggerAction: 'all'
                , listeners: {
                    select: function(combo, record, index) {
                     ...
                     //   var cyc = Ext.getCmp('CYC').getValue();
                        ...
                        var zdwStore = Ext.create('Ext.data.Store', {
                            proxy: {
                                type: 'ajax',
                                url: '../../../api/system/jdstat_djsj1.aspx',
                                extraParams: {
                                    dwType: dwType,
                               //     CYC: cyc,
                                    BNY: month,
