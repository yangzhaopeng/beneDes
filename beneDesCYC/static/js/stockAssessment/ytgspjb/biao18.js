        ...
        search: function() {
         ...
         //   var cyc = Ext.getCmp('CYC').getValue();
          ...
          var lendMonth = Ext.getCmp('lendMonth').getValue();
            ...
            document.getElementById('center').setAttribute('src', iframeUrl + '?startMonth=' + startMonth + '&endMonth=' + endMonth + '&lstartMonth=' + lstartMonth + '&lendMonth=' + lendMonth + '&Dropdl=' + Dropdl );
