Ext.onReady(function() {
    ...
    var events = {
        ...
        //下载模板
        download: function() {
            window.location.href = "../../static/dataTemplateExcel/gas/2集气站费用.xls";
        },
        // “删除”按钮点击事件
...
//                Ext.Msg.alert('提示', '请选择文件！');
            ...
            if (form.isValid()) {
                ...
                form.submit({
                    ...
                    url: '../../api/system/uploadfile3.aspx?cyctype=cqc_id&FT_TYPE=JQZ',
                    waitMsg: '正在上传...',
