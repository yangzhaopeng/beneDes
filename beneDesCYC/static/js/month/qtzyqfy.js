...
//            }
            if (form.isValid()) {
                ...
                form.submit({
                    //url: '../../api/system/uploadfile5.aspx',
                    url: '../../api/system/uploadfile3.aspx?cyctype=cqc_id&FT_TYPE=ZYQ',
                    waitMsg: '正在上传...',
        ...
        //下载模板
        download: function() {
            window.location.href = "../../static/dataTemplateExcel/gas/5作业区费用.xls";
        },
        // “编辑”按钮点击事件
        editClick: function() {
            if (!events.getGridSel()) return;
