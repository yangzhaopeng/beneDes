...
//        },
        ...
        document.getElementById('center').contentDocument.getElementById("FT").click();
            Loading.onIfrmaLoad('center');
        },
        ...
        document.getElementById('center').contentDocument.getElementById("BC").click();
            Loading.onIfrmaLoad('center');
        }
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            '-',
            { xtype: 'label', text: '年月', margin: '0 0 0 20' },
            { xtype: 'textfield', name: 'Date', id: 'Date', value: inputMonth, width: 100 },
            '-',
            { xtype: 'button', text: '初始化', iconCls: 'icon-search', margin: '0 0 0 15', handler: events.search, hidden: true, hiddenLabel: true  },
            '-',
//            { xtype: 'button', text: '全选', iconCls: 'icon-send', margin: '0 0 0 15', handler: events.allSelect },
//            '-',
//            { xtype: 'button', text: '取消', iconCls: 'icon-send', margin: '0 0 0 15', handler: events.cancel },
//            '-',
            { xtype: 'button', text: '分摊', iconCls: 'icon-send',  handler: events.initialise },
            '-',
            { xtype: 'button', text: '保存', iconCls: 'icon-send', handler: events.save }
