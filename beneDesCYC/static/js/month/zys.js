Ext.onReady(function() {
    ...
    var events = {
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除资源税信息？', function(result) {
                if (result == 'yes') {
                NY: month
                    dataJs.get(
                        '../../api/month/zys.aspx',
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
          ...
          //{text: '作业区', dataIndex: 'DEP_NAME'},
            ...
            { text: '资源税（%）', width: 160, dataIndex: 'ZYS', flex: 1 }
        ],
