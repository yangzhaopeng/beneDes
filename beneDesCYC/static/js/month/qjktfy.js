Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加期间勘探费用信息');
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除期间勘探费用信息？', function(result) {
                if (result == 'yes') {
                NY: month
                    dataJs.get(
        ...
        editClick: function() {
            ...
            isAdd = false;
            windowDialog.setTitle('编辑期间勘探费用信息');
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
          ...
          //{text: '作业区', dataIndex: 'DEP_NAME'},
            ...
            {text: '期间费用（元/吨）', dataIndex: 'QJFY', flex: 1},
            {text: '勘探费用（元/吨）', dataIndex: 'KTFY', flex: 1}
        ],
