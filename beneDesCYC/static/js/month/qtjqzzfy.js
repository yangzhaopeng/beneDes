Ext.onReady(function() {
    ...
    var events = {
        ...
        //下载模板
        download: function() {
            window.location.href = "../../static/dataTemplateExcel/gas/3集气总站费用.xls";
        },
        // “添加”按钮点击事件
        addClick: function() {
            isAdd = true;
...
//                Ext.Msg.alert('提示', '请选择文件！');
            ...
            if (form.isValid()) {
                ...
                form.submit({
                    //url: '../../api/system/uploadfile7.aspx',
                    url: '../../api/system/uploadfile3.aspx?cyctype=cqc_id&FT_TYPE=JQZZ',
                    waitMsg: '正在上传...',
