Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加输差信息');
            formPanel.getForm().reset();
            formPanel.getForm().findField('DEP_ID').setReadOnly(false);
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除该输差信息？', function(result) {
                if (result == 'yes') {
                NY: month
                    dataJs.get(
                        '../../api/month/sc_info.aspx',
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        fields:['NY', 'DEP_ID', 'XSYPDM', 'SC', 'DEP_NAME', 'XSYPMC'],
        autoLoad: true
    });
