...
//            }
            if (form.isValid()) {
                ...
                form.submit({
                    url: '../../api/system/uploadfile3.aspx?cyctype=cyc_id&FT_TYPE=CYC',
                    waitMsg: '正在上传...',
        ...
        //下载模板
        download: function() {
            window.location.href = "../../static/dataTemplateExcel/oil/2采油厂费用.xls";
        },
        // “编辑”按钮点击事件
        editClick: function() {
            if (!events.getGridSel()) return;
    ...
    */
    ...
    var sPanel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            { xtype: 'fileuploadfield', buttonText: '导&nbsp入', name: 'UPLOADFILE',buttonOnly:true, id: 'UPLOADFILE', 
