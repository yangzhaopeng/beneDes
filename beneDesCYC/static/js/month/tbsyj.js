Ext.onReady(function() {
    ...
    var events = {
        ...
        addClick: function() {
            isAdd = true;
            windowDialog.setTitle('添加石油特别收益金信息');
        ...
        deleteClick: function() {
            ...
            Ext.Msg.confirm('确认', '您确定要删除石油特别收益金信息？', function(result) {
                if (result == 'yes') {
                NY: month
                    dataJs.get(
                        '../../api/month/tbsyj.aspx',
        ...
        editClick: function() {
            ...
            isAdd = false;
            windowDialog.setTitle('编辑石油特别收益金信息');
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
          ...
          //{text: '作业区', dataIndex: 'DEP_NAME'},
            ...
            {text: '石油特别收益金（元/吨）', dataIndex: 'TBSYJ', flex: 1}
        ],
