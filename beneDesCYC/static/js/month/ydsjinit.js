Ext.onReady(function() {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        tbar: [
            ...
            '-',
            { xtype: 'button', text: '初始化', iconCls: 'icon-search', handler: events.search, hidden: true, hiddenLabel: true  },
            '-',
            ...
            '-',
            { xtype: 'button', text: '初始化', iconCls: 'icon-init',  handler: events.initialise }
