...
//                Ext.Msg.alert('提示', '请选择文件！');
            ...
            if (form.isValid()) {
                ...
                form.submit({
                    url: '../../api/system/uploadfile3.aspx?cyctype=cyc_id&FT_TYPE=ZRZ',
                    waitMsg: '正在上传...',
        ...
        //下载模板
        download: function() {
            window.location.href = "../../static/dataTemplateExcel/oil/5自然站费用.xls";
        },
        // “编辑”按钮点击事件
        editClick: function() {
            if (!events.getGridSel()) return;
