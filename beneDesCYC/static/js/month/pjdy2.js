...
//                    NY: month
        ...
        //下载模板
        download: function() {
//            window.location.href = "excel/oil/9评价单元.xls";
             window.location.href = "../../static/dataTemplateExcel/oil/9评价单元.xls";
        },
...
//               height: 260,
        ...
        margin: '-2 10 18 0', height: 20 ,   listeners:{
            ...
            { text: '地下原油粘度（毫帕秒）', dataIndex: 'DXYYND' },
            { text: '油井总井数（口）', dataIndex: 'YJZJS' },
            { text: '油井开井数（口）', dataIndex: 'YJKJS' },
            { text: '注水井总井数（口）', dataIndex: 'SJZJS' },
            { text: '注水井开井数（口）', dataIndex: 'SJKJS' },
            { text: '月注水量（万方）', dataIndex: 'ZSJ' },
            { text: '累计注水量（万方）', dataIndex: 'LJZSL' },
            { text: '注气井总井数（口）', dataIndex: 'ZQJZJS' },
            { text: '注气井开井数（口）', dataIndex: 'ZQJKJZ' },
            { text: '月注气量（万方）', dataIndex: 'ZQL' },
            { text: '累计注气量（万方）', dataIndex: 'LJZQL' },
            { text: '月产油量（万吨）', dataIndex: 'CYOUL' },
            { text: '累计产油量（万吨）', dataIndex: 'LJCYOUL' },
            { text: '月产液量（万吨）', dataIndex: 'CYL' },
            { text: '累计产液量（万吨）', dataIndex: 'LJCYL' },
            { text: '月产气量（万方）', dataIndex: 'CQL' },
            { text: '累计产气量（万方）', dataIndex: 'LJCQL' },
            { text: '销售油品', dataIndex: 'XSYPMC' },
            { text: '是否评价', dataIndex: 'SFPJ', renderer: function(value) {
                if (value == '0') return '否';
                else if (value == '1') return '是';
