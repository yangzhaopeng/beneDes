<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame63.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame63" %>
...
//        var jbny = '<%=Session["jbny"].ToString() %>';
    ...
    <script src="../../static/js/query/djytpj.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>
