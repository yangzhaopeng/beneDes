<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame61.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame61" %>
...
//        var bny = '<%=Session["bny"].ToString() %>';
    ...
    <script src="../../static/js/query/djydsj.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>