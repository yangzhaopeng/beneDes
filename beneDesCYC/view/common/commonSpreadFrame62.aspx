<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame62.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame62" %>
...
//        var jbny = '<%=Session["jbny"].ToString() %>';
    ...
    <script src="../../static/js/query/djgfpj.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>