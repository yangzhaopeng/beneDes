<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame60.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame60" %>
...
//        var bny = '<%=Session["bny"].ToString() %>';
    ...
    <script src="../../static/js/query/bscpft.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>
