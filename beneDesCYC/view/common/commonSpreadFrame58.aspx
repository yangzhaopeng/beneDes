<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame58.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame58" %>
...
//        var bny = '<%=Session["bny"].ToString() %>';
    ...
    <script src="../../static/js/query/ggfy.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>
