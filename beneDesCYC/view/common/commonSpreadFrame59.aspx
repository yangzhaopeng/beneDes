<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame59.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame59" %>
...
//        var bny = '<%=Session["bny"].ToString() %>';
    ...
    <script src="../../static/js/query/djfy.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>
