<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonSpreadFrame54.aspx.cs" Inherits="beneDesCYC.view.common.commonSpreadFrame54" %>
         ...
         switch (datey)
                {
                    ...
                    case "01": datey = "12"; n = int.Parse(daten.ToString()) - 1; daten = n.ToString(); break;
                    default: break;
                }
        var leny = (daten + datey).toString();
    </script>
    <script src="../../static/js/common/loading.js" type="text/javascript"></script>
    <script src="../../static/js/oilAssessment/bjjwxjfxb/biao18.js" type="text/javascript"></script>
</head>
<body>
</body>
</html>