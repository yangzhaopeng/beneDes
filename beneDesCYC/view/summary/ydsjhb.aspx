<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ydsjhb.aspx.cs" Inherits="beneDesCYC.view.summary.ydsjhb" %>
 ...
 <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">汇总计算开发数据</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">创建单井月度数据</span></td>
                                                <td style="width: 500px; height: 26px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">汇总评价单元月度数据</span></td>
                                                <td style="width: 500px; height: 26px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">汇总计算区块月度数据</span></td>
                                                <td style="width: 500px; height: 26px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">汇总计算单井费用</span></td>
                                                <td style="width: 500px; height: 26px;">
                                                    <asp:Label ID="Label7" runat="server" Font-Size="Smaller" ForeColor="Red" Text="Label"></asp:Label></td>
                                                <td style="width: 10px; height: 26px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 26px;">
                                                    <span style="font-size: 10pt">汇总计算单井成本</span></td>
                                                <td style="width: 500px; height: 26px;">
                                                    <asp:Label ID="Label8" runat="server" Font-Size="Smaller" ForeColor="Red" Text="Label"></asp:Label></td>
                                                <td style="width: 10px; height: 26px;">
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td style="width: 500px; height: 26px;">
                                        <asp:Label ID="Label6" runat="server" Font-Size="10pt" ForeColor="#FF0000" Text="Label"></asp:Label></td>
                                    <td style="width: 10px; height: 26px;">
                                    </td>
                                </tr>
                                <tr>
