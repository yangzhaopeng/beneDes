<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jqzzft.aspx.cs" Inherits="beneDesCYC.view.month.jqzzft" %>
...
<body style="overflow: hidden; width: 100%; height: 700px; text-align: center; background-image: url(/static/image/bg.jpg)">
    <form id="Form1" method="post" runat="server">
    <table id="Table7" style="width: 100%; height: 700px; text-align: center" cellspacing="0"
                                        ...
                                        <table id="Table14" cellspacing="0" cellpadding="0" width="96%" style="text-align: center"
                                            ...
                                            <tr class="css">
                                                <td style="height: 19px">
                                                    <div style="text-align: right; font-size:medium; height: 14px;">
                                                        选择集气总站：</div>
                                                </td>
                                                <td style="height: 19px; text-align: left" valign="middle">
                                                    <asp:CheckBoxList ID="zyqchklist" runat="server" Height="21px" RepeatDirection="Horizontal"
                                                        RepeatColumns="5" Width="80%" Font-Size="Small">
                                                    </asp:CheckBoxList>
                                                </td>
                                            </tr>
                                            <tr class="css">
