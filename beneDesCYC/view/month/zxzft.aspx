<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zxzft.aspx.cs" Inherits="beneDesCYC.view.month.zxzft" %>
                                        ...
                                        <table id="Table14" cellspacing="0" cellpadding="0" width="96%" style="text-align: center"
                                            ...
                                            <tr class="css">
                                                ...
                                                <td style="height: 10px; width: 86%; text-align: left">
                                                    <asp:DropDownList ID="zyqddl" runat="server" AutoPostBack="true" Width="188px" OnSelectedIndexChanged="zyqddl_SelectedIndexChanged"
                                                        Font-Size="Small">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="css">
                                                ...
                                                <td style="height: 19px; text-align: left" valign="middle">
                                                    <asp:CheckBoxList ID="zxzchk" runat="server" Height="21px" RepeatDirection="Horizontal"
                                                        RepeatColumns="5" Width="538px" Font-Size="Small">
                                                    </asp:CheckBoxList>
                                                </td>
                                            </tr>
                                            <tr class="css">
