<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dataClearOil.aspx.cs" Inherits="beneDesCYC.view.month.dataClearOil" %>
...
<head runat="server">
    ...
    <script src="../../static/js/month/dataClearOil.js" type="text/javascript"></script>
