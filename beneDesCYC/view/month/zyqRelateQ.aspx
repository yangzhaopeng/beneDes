<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zyqRelateQ.aspx.cs" Inherits="beneDesCYC.view.month.zyqRelateQ" %>
...
<head>
    ...
    <script src="../../static/js/month/zyqRelateQ.js" type="text/javascript"></script>
