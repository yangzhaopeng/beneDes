<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cycft.aspx.cs" Inherits="beneDesCYC.view.month.cycft" %>
                                        ...
                                        <table id="Table14" cellspacing="0" cellpadding="0" width="96%" style="text-align: center"
                                            ...
                                            <tr class="css">
                                                ...
                                                <td style="height: 19px; text-align: left" valign="middle">
                                                    <asp:CheckBoxList ID="cycchklist" runat="server" Height="21px" RepeatDirection="Horizontal"
