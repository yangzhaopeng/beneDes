<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zyqRelateY.aspx.cs" Inherits="beneDesCYC.view.month.zyqRelateY" %>
...
<head>
    ...
    <script src="../../static/js/month/zyqRelateY.js" type="text/javascript"></script>
