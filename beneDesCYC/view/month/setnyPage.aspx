<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="setnyPage.aspx.cs" Inherits="beneDesCYC.view.month.setnyPage" %>
...
<head runat="server">
    ...
    <script src="../../static/js/month/setnyPage.js" type="text/javascript"></script>
