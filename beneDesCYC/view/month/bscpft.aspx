<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bscpft.aspx.cs" Inherits="beneDesCYC.view.month.bscpft" %>
			...
			<table id="Table7" style="WIDTH: 710px; HEIGHT: 700px; text-align:center" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td valign="top" align="center" style="width: 716px">
						<table id="Table10" cellspacing="0" cellpadding="0" width="680" style="text-align:center"  border="0">
							<tr>
									...
									<table id="Table13"  style="border-color:#FFFFFF; background-color:#FFFFFF; height: 57px;" 
										...
										<tr>
											<td style="background-color:#FFFFFF; vertical-align:top" >
												<table id="Table14" cellspacing="0" cellpadding="0" width="96%" style="text-align:center"  border="0">
													<%--<tr class="css">
													...
													<tr class="css">
														...
														<td style="height: 19px;text-align:left" valign="middle">
                                                            <asp:CheckBoxList ID="bscpchk" runat="server" Height="21px" 
                                                                RepeatDirection="Horizontal" RepeatColumns="5"
                                                                Width="549px" Font-Size="Small">
                                                            </asp:CheckBoxList></td>
													</tr>
													<tr class="css">
							...
							<tr><td style="height:20px; width: 684px;"></td></tr>
						</table>
                      <asp:Button ID="QX" runat="server" Text="全选" onclick="QX_Click" style="display: none;" />
						...
						<table style="border-color:#83B1D3" ><tr><td align="left" valign="top" style="height: 178px; width: 110px;" >
